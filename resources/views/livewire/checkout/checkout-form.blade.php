...
<div>
    @if ($items->isEmpty())
        ...
        />
    @else
        <div class="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(300px,380px)] lg:gap-16">
            <form wire:submit="placeOrder" class="space-y-6">
                ...
                <div>
                    <label for="customer_name" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Full name</label>
                ...
                <div>
                    <label for="phone" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Phone number</label>
                ...
                <div>
                    <label for="city" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">City</label>
                ...
                <div>
                    <label for="address" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Full address</label>
                ...
                <div>
                    <label for="email" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Email <span class="text-muted">(optional)</span></label>
                ...
                <div>
                    <label for="postal_code" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Postal code <span class="text-muted">(optional)</span></label>
                ...
                <div>
                    <label for="notes" class="mb-2 block text-[11px] uppercase tracking-[0.16em]">Order notes <span class="text-muted">(optional)</span></label>
                ...
                <div class="bg-ivory p-5">
                    <p class="text-[11px] uppercase tracking-[0.16em]">Payment</p>
            ...
            <aside class="h-fit bg-ivory p-6 md:p-8">
                <h2 class="text-[11px] uppercase tracking-[0.16em]">Your order</h2>
                <ul class="mt-6 divide-y divide-sand" role="list">
